            ...
            <SwiperSlide key={i}>
              <div className="transition-all w-fit ease-linear duration-300 flex items-center justify-center">
                <Link
                  ...
                  className="w-full max-sm:max-w-[295px] mx-auto max-sm:flex max-sm:flex-col max-sm:justify-center hover:shadow-[rgba(0,0,0,0.3)_0px_19px_38px,rgba(0,0,0,0.22)_0px_15px_12px]"
                >
                  <Image
                    src={obj.image}
                    alt="clothes"
