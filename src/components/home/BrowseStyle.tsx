      ...
      <div className="w-full mx-auto max-w-[1240px] bg-[#F0F0F0] rounded-[40px] max-xl:px-4">
        ...
        <div className="flex items-center gap-5 justify-center max-md:flex-wrap">
          <Image
            ...
            width={407}
            height={289}
            className="w-full max-w-[407px] pointer-events-none max-xl:max-w-[500px] max-xl:h-[310px] max-lg:max-w-[350px] max-lg:h-[260px] max-sm:max-w-[310px] max-sm:h-[190px] transition-all duration-300 hover:scale-105"
          />
          <Image
            ...
            width={684}
            height={289}
            className="w-full max-w-[684px] pointer-events-none max-xl:max-w-[500px] max-xl:h-[310px] max-lg:max-w-[350px] max-lg:h-[260px] max-sm:max-w-[310px] max-sm:h-[190px] transition-all duration-300 hover:scale-105"
          />
        </div>
